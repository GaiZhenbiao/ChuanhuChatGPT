...
def predict(
    ...
    if stream:
        ...
        for chatbot, history, status_text, all_token_counts in _iter:
...
def reduce_token_size(
    ...
    flag = False
    msg = None
    for chatbot, history, status_text, previous_token_count in _iter:
