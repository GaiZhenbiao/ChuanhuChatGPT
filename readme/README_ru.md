...
<sup>New!</sup> Совершенно новый пользовательский интерфейс! Он такой изысканный, не похожий на Gradio, и даже с эффектом матового стекла!
...
### 💪 Мощные функции
- **Чуаньху ассистент**: подобно AutoGPT, полностью автоматизированное решение вашей проблемы;
...
- **Локальная установкаLLL**: одним щелчком разверните свою собственную модель языка большого размера.
