...
- Rename history record, easy to find in the future;
- <sup>New!</sup> Magically auto-name the history record, let LLM understand the conversation content, and automatically name the history record for you!
- <sup>New!</sup> Search history record, supports regular expressions!
